//TUBES GKV TRUK GAME
//main program
//JasonAlHilalSabdaDewa_24060120120002_A1
//
//
//
...
#include "D:\Informatics\ProjectC\GKV_TRUK_Sementara\lib\truck.h"
#include "D:\Informatics\ProjectC\GKV_TRUK_Sementara\lib\ground.h"
#include "D:\Informatics\ProjectC\GKV_TRUK_Sementara\lib\objects.h"
...
void RenderScore() {
    ...
    renderBitmapString(5, 30, 0,s);
    sprintf(up,"Tekan UP untuk maju");
    glColor3f(1,1,1);
     //y axis inverted ,atas(-),kanan(+);
    renderBitmapString(740, 570, 0,up);
    glPopMatrix();
}
...
void display() {
   ...
   glutPostRedisplay();
    ...
    if (buildings){
        ...
        Batu rock2a(40,10,10,25,0.5,0.6,0.4);
        cekTabrakan(rock2a, &buildings);
        Batu rock3a(40,10,70,25,0.4,0.4,0.7);
        cekTabrakan(rock3a, &buildings);
        Batu rock4a(40,10,110,25,0.8,0.4,0.4);
        cekTabrakan(rock4a, &buildings);
        Batu rock5a(40,10,150,25,0.76,0.4,0.4);
        cekTabrakan(rock5a, &buildings);
        Batu rock6a(40,10,-200,25,0.33,0.8,0.4);
        cekTabrakan(rock6a, &buildings);
        Batu rock7a(40,10,-240,25,0.46,0.4,0.6);
        cekTabrakan(rock7a, &buildings);
        Batu rock8a(50,10,250,50,0.58,0.4,0.6);
        cekTabrakan(rock8a, &buildings);
        Batu rock9a(40,3,-50,10,0.33,0.4,0.4); //urut seperti pagar
        cekTabrakan(rock9a, &buildings);
        Batu rock10a(40,3,-65,10,0.7,0.4,0.4);
        cekTabrakan(rock10a, &buildings);
        Batu rock11a(40,3,-80,10,0.47,0.4,0.4);
        cekTabrakan(rock11a, &buildings);
        Batu rock12a(40,3,-95,10,0.74,0.6,0.4);
        cekTabrakan(rock12a, &buildings);
        Batu rock13a(40,3,-110,10,0.55,0.6,0.6);
        cekTabrakan(rock13a, &buildings);
        Batu rock14a(40,3,-125,10,0.45,0.4,0.5);
        cekTabrakan(rock14a, &buildings);
        Batu rock15a(40,10,-160,25,0.67,0.6,0.6);
        ...
        Batu rock3c(40,12.5,430,25,0.8,0.4,0.7);
        ...
        Batu rock8e(270,0,-335,10,0.44,0.8,0.8);
        cekTabrakan(rock8e, &buildings);
        Batu rock9e(270,0,-355,10,0.55,0.6,0.6);
        cekTabrakan(rock9e, &buildings);
        Batu rock10e(290,5,-335,10,0.88,0.7,0.4);
        ...
        Batu rock3f(300,10,10,25,0.44,0.4,0.4);
        ...
        Mobil mobil9a(160,1.4,280, 0); //depan(+),kori -
        ...
        Mobil mobil11a(288,1.8,-280, 180); //belakang+,kiri-
        ...
        Mobil mobil12a(172,1.8,-280, 180);
        ...
        Bangunan1 bang1x(-270, 10, -240, 25,0.4,0.25,0.5, 5);
        ...
        Bangunan1 bang2x(-270, 10, -160, 25,0.3,0.35,0.5, 2);
        ...
        Bangunan1 bang5x(-300, 10, 10, 25,0.4,0.15,0.5, 1);
        ...
        Bangunan1 bang8x(-300, 10, 220, 25,0.3,0.21,0.3, 1);
...
//        Mobil mobil14a(-380,1.8,340, 180); //depan-
        ...
        Bangunan1 bang15x(-380, 10, -245, 25,0.4,0.15,0.9, 1);
        ...
        Bangunan1 bang18x(-380, 10, -125, 25,0.35,0.95,0.4, 1);
        ...
        Bangunan1 bang19x(-380, 10, -85, 25,0.3,0.15,0.51, 1);
        ...
        Bangunan1 bang34x(-180, 10, 360, 25,0.34,0.3,0.1, 1);
        ...
        Bangunan1 bang41x(-180, 10, 440, 25,0.34,0.3,0.1, 2);
        ...
        Bangunan1 bang44x(-270, 10, 440, 25,0.4,0.4,0.1, 1);
        cekTabrakan (bang44x, &buildings);
        Bangunan1 bang45x(-60, 10, 440, 25,0.5,0.21,0.31, 1);
        ...
        //2
        Batu rock1b(-50,20,300,50,0.45,0.45,0.4);
        cekTabrakan(rock1b, &buildings);
        Batu rock2b(-30,5,360,10,0.7,0.6,0.4);
        cekTabrakan(rock2b, &buildings);
        Batu rock3b(-50,0,360,10,0.5,0.8,0.4);
        cekTabrakan(rock3b, &buildings);
        Batu rock4b(-30,0,340,10,0.8,0.6,0.4);
        cekTabrakan(rock4b, &buildings);
        Batu rock5b(-40,10,240,25,0.3,0.3,0.4);
        cekTabrakan(rock5b, &buildings);
        Batu rock6b(-40,10,200,25,0.5,0.44,0.4);
        cekTabrakan(rock6b, &buildings);
        Batu rock7b(-40,10,160,25,0.65,0.75,0.4);
        cekTabrakan(rock7b, &buildings);
        Batu rock8b(-40,10,120,25,0.48,0.44,0.4);
        cekTabrakan(rock8b, &buildings);
        Batu rock9b(-40,10,20,25,0.88,0.37,0.4);
        cekTabrakan(rock9b, &buildings);
        Batu rock10b(-40,10,-20,25,0.65,0.77,0.4);
        cekTabrakan(rock10b, &buildings);
        Batu rock11b(-50,20,-100,50,0.72,0.99,0.4);
        cekTabrakan(rock11b, &buildings);
        Batu rock12b(-40,10,-140,25,0.33,0.55,0.4);
        ...
        Batu rock1d(-160,10,-240,25,0.45,0.46,0.4);
        cekTabrakan(rock1d, &buildings);
        Batu rock2d(-200,10,-240,25,0.6,0.44,0.4);
        cekTabrakan(rock2d, &buildings);
        Batu rock3d(-240,10,-240,25,0.8,0.56,0.4);
        cekTabrakan(rock3d, &buildings);
        Batu rock4d(-160,10,-160,25,0.3,0.88,0.4);
        cekTabrakan(rock4d, &buildings);
        Batu rock5d(-200,10,-160,25,0.5,0.54,0.4);
        cekTabrakan(rock5d, &buildings);
        Batu rock6d(-240,10,-160,25,0.7,0.33,0.4);
        cekTabrakan(rock6d, &buildings);
        Batu rock7d(-100,10,-150,50,0.3,0.32,0.4);
        cekTabrakan(rock7d, &buildings);
        Batu rock8d(-50,0,-170,10,0.9,0.78,0.4);
        cekTabrakan(rock8d, &buildings);
        Batu rock9d(-30,5,-170,10,0.4,0.88,0.4);
...
int main(int argc, char **argv){
    ...
    glutCreateWindow("3D Truck Game IF UNDIP");
